    ...
    <section class="w-full px-6 antialiased bg-white">
        <div class="mx-auto max-w-7xl">
            <nav class="relative z-50 h-24 select-none">
                <div class="container relative flex flex-wrap items-center h-24 mx-auto overflow-hidden font-medium border-b justify-center">
                    <div class="flex items-center h-full">
                        <a href="{{ url('/home') }}" class="inline-block py-4">
